    ...
    return (
        <div className="flex-center projects-page">
            <section className="portfolio-container">
                <div className="cube-container" onTouchStart={() => { 
                ...
                <div className="cube-container" onTouchStart={() => { setTouch((prev) => ({ ...prev, 2: !prev[2] })) }}>
                    <div className="cube">
                ...
                <div className="cube-container" onTouchStart={() => { setTouch((prev) => ({ ...prev, 3: !prev[3] })) }}>
                    <div className="cube ">
                        <img src="/readmegenerator.gif" className="thumbnail" />
                ...
                <div className="cube-container" onTouchStart={() => { setTouch((prev) => ({ ...prev, 4: !prev[4] })) }}>
                    <div className="cube ">
                ...
                <div className="cube-container" onTouchStart={() => { setTouch((prev) => ({ ...prev, 5: !prev[5] })) }}>
                    <div className="cube ">
                ...
                <div className="cube-container" onTouchStart={() => { setTouch((prev) => ({ ...prev, 6: !prev[6] })) }}>
                    <div className="cube ">
                ...
                <div className="cube-container" onTouchStart={() => { setTouch((prev) => ({ ...prev, 7: !prev[7] })) }}>
                    <div className="cube ">
                ...
                <div className="cube-container" onTouchStart={() => { setTouch((prev) => ({ ...prev, 8: !prev[8] })) }}>
                    <div className="cube ">
